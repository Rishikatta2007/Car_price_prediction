...
st.header("Car Price Predection ML Model")
...
seats = st.slider('No of Seats',5,12)
...
if st.button("Predict"):
    ...
    car_price_int = int(car_price[0]) 
    st.markdown(f"Your car price is going to be:  ₹{car_price_int}")
